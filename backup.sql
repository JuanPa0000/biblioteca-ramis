...
CREATE TABLE `reservas` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_reservas_users_idx` (`users_id`),
  KEY `fk_reservas_libros1_idx` (`libros_id`),
  CONSTRAINT `fk_reservas_libros1` FOREIGN KEY (`libros_id`) REFERENCES `libros` (`id`),
  CONSTRAINT `fk_reservas_users` FOREIGN KEY (`users_id`) REFERENCES `users` (`id`)
...
INSERT INTO `users` VALUES (1,'jfuentes20943@iesjoanramis.org','Dequa20.','jfuentes20943',111,'Joan'),(4,'prueba@gmail.com','Dequa20.','juanpi',111,'Joan');
...
-- Dump completed on 2026-02-01 22:59:21
